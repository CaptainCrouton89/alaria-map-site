---
id: "daemon-the-ladder-blesser"
name: "The Ladder-Blesser"
entityType: daemon
blurb: "Domains: coin-and-contract, noble-merchant tradition, the ledger that doubles as a charter; current cohort; Belenstrope household patron of the deal that lifts a house."
weight: minor
tags: ["daemon"]
aliases: []
sources: []
...
<!-- author-notes -->
Deliberate deviation: the slot recipe specifies a Belen-/Gren- prefix in the halfling Romance trade register, with -os or -in terminal. The Ladder-Blesser is an English-descriptive name instead, in the F4-adjacent halfling register that is otherwise unattested for halflings. The doctrinal reason: the patron was named by outsider trade-partners before insider Belenstrope dealers had coined a word for him, and the Belenstrope houses adopted the outsider name on the grounds that being *seen* using the ladder is part of the worship. The name's adoption from outside is itself the doctrinal claim — a Belenstrope-coined Belen-rooted name would have been a more private worship, and the Ladder-Blesser is not a private daemon.
