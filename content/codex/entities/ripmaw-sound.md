...
name: "Ripmaw Sound"
entityType: water
blurb: "The western waters between Iqes and the Upoceax mainland, Ripmaw Sound earned its name from the volcanic rock formations that lurk beneath its surface."
coordinates: [41, 290]
zoomLevel: 5
tags: ["sea", "geography", "hazard"]
sources: ["all_sections_formatted/Upoceax.md#L703"]
---
...
But the old Qindo pilots pour offerings into certain waters and avoid certain channels regardless of the tide. They say the sound has moods, and a wise sailor learns to read them. What creates those moods — currents, pressure, or something with intentions — they decline to specify.
