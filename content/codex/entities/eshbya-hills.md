...
blurb: "A region of low hills in the southern foothills of the Kelder Mountains, within Deo Esari's claimed territory."
coordinates: [69, 446]
zoomLevel: 5
tags: ["hills", "geography", "ruins", "contaminated"]
sources: ["all_sections_formatted/Upoceax.md#L1463"]
relations:
  - { rel: spatial, kind: within, target: "3498" }
---
A region of low hills in the southern foothills of the Kelder Mountains, within Deo Esari's claimed territory. Once home to several titan-bone harvesting villages. Abandoned 200 years ago after the contamination spread.

#### Geography

The Eshbya Hills lie west of the main Kelder range, in the transitional zone between mountain and lowland. The terrain is rolling, forested in places, with numerous exposed rock formations where titan bones were once quarried.
...
- **Novranas**: Largest of the three villages. Administrative center for the southern harvesting operations.
- **Salenial**: Mining village focused on a particularly rich titan deposit.
- **Myrth**: Processing settlement where raw bone was prepared for transport.

All three are intact, frozen in time. Personal belongings remain where they were left. The evacuation was orderly but permanent.
