...
> They can have the grain. They can have the boys, since they always do. What they will never have is a straight answer.
> — Toveri, a Pyris fisher, to a Tarkhetan assessor
...
<!-- author-notes -->
Canon: the Pyrisi rest on human-dwarf interbreeding, asserted by the Pyris region file (id 2568). RESOLVED — dwarves are ruled IN as modified Gaea-flesh (goal.md / problem.md), so the human×dwarf cross is a valid flesh×flesh cross. The making section authors it as one closed founding cross fixed by island isolation, not a slow drift. Filed under race-human as primary parent; no race-dwarf subraceOf edge added (one subraceOf per entity).
