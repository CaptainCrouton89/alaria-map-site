...
name: "Ekfusy"
entityType: fortress
blurb: "A functional but miserable fortress on Midton Island, watching the eastern approaches to the Tarkhon Passage."
coordinates: [148, 204]
zoomLevel: 5
tags: ["fortress", "poi"]
sources: ["all_sections_formatted/Rimihuica.md#L226"]
relations:
  - { rel: spatial, kind: within, target: "2539" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme fortress doc. Geography consistent with map (Midton Island, E approach to passage). Mildly padded (bullet lists) and redundant with parent region 2539 Midton body; could trim overlap."
---
