...
name: "Moigos"
entityType: region
blurb: "The northern state on Petrona Septia Island, Moigos occupies the lowland forests and river valleys north of the Screech Peaks."
coordinates: [36, 339]
zoomLevel: 3
tags: ["state", "nation"]
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme Kappa crime-state. Geography matches map: inland settlements clustered NW along Qulyintes/Skraigos rivers, no significant coast, Screech Peaks to south. Settlement and river leads all confirmed against pins."
---
...
**Calentia** — Upstream on the Qulyintes, closer to the Screech Peaks. Calentia handles trade coming over the mountains from Ios and serves as a waystation for goods moving to and from Thetin. The town is drier than the capital, built on higher ground where the river valley narrows.
