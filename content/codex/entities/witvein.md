...
name: "Witvein"
entityType: region
blurb: "The eastern Nysanna Range, on its northern slopes facing the polar wastes, is dominated by the region known as Witvein—a maze of tunnel-laden glaciers that…"
coordinates: [175, 28]
zoomLevel: 4
sources: ["all_sections_formatted/Clueanda.md#L6313"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme far-north ice-goblin (Wydling) glacier civilization in eastern Nysanna Range. Map-consistent: sits in northern mountains at polar boundary. References Niquous (1326, white dragon, ~34px W) as bordering threat — accurate adjacency."
---
