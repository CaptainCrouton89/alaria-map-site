---
id: "manual-mphcu2e4-q94ei"
name: "Siren Islands"
entityType: region
blurb: "Basalt stacks at the western edge of the Shattered Sea, where sirens sing a lament that stills any crew who hears it."
coordinates: [18, 188]
zoomLevel: 3
relations:
  - { rel: spatial, kind: within, target: "4165" }
  - { rel: spatial, kind: liesOn, target: "4166" }
---
...
> Saveli came off the rocks alive because he was below in the bilge with a fever when his ship struck, too far gone to climb toward the song with the rest of them. He remembers the chorus and nothing of the wreck. "It was not sad for us," he says. "It was sad for someone else, and there was no room in it for us at all." He has not gone back to sea.
> — as told at Tollgate's harbor

<!-- author-notes -->
Provisional coined name: **Saveli** (Drachma/Romance human register per onomastics-human.md Family 1; grep -rli clean at authoring). Flag if it collides with a future entity.

GM answer to the song's cause (withheld from body per "mysteries must have answers"): the sirens are the remnant of the islands' original people, drowned when a section of the volcanic plateau subsided and took their settlement under in a single night. The dead were never recovered. The lament is their funeral song, which cannot end because the funeral was never completed; every later wreck's drowned are genuinely folded into the chorus, which is why it grows. A campaign that recovered and laid to rest the original drowned could, in principle, end the song. Date of the subsidence left open deliberately.

Cosmological resolution (rectification, settled): the lament does NOT command, direct, or aim Faesong. Per canon, Faesong (the emotion-and-harmony face of Ezz) is heard and felt, not commanded—druids attune to it, bards reproduce fragments, and the fae ARE it. The sirens are song-sensitive beings (per the GM-truth above, the drowned original people / their remnant), NOT condensed Faesong and NOT fae. Their grief is genuine and so true to the ambient current that the Faesong already in the air resonates with it and carries it across the water; they harmonize, they do not wield. Body updated accordingly—no 'drawn taut / aimed at whoever can hear' command language remains.

Onomastics decision: chose option (a) — translated the "gaelic melodies" flavor into a sound-palette description (thin, high, modal, unresolved intervals, keening) with no real-world ethnonym. No siren name-register invented; no siren creature/race entity created. Did NOT author a siren onomastics sheet. My read: a full siren sheet is NOT warranted yet (sirens are unseen, unnamed, and have no name pool in-world); a creature entity is also not warranted this cycle (one region entry covers them). Flag only if downstream work needs to name individual sirens.

Spatial edge added: liesOn -> 4166 (the Shattered Sea). Chose Shattered Sea over the Iron Sea because the Cliffs of Syquindonos sit between these islands and the Iron Sea (cliffs are ~9 units N of the stacks and border the Iron Sea on their own north face), so the islands do not directly touch the Iron Sea. liesOn the Shattered Sea is the truthful adjacency and needs no backlink.
