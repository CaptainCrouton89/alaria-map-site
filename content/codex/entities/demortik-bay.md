...
name: "Demortik Bay"
entityType: water
blurb: "The western arm of the Gulf of Norag curves around a jungle cape topped by Demonwatch—a darkstone palace visible from miles out to sea."
coordinates: [136, 327]
zoomLevel: 5
sources: ["all_sections_formatted/Greenwater_Isles.md#L249"]
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Demortik Bay: coherent, geo-consistent (western arm of Gulf of Norag, jungle cape topped by Demonwatch). Left unclaimed by 2825 as it is a water arm of Gulf of Norag, not land territory."
relations:
  - { rel: spatial, kind: within, target: "2825" }
---
