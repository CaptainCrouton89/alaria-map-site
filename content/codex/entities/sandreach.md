...
sources: ["all_sections_formatted/Upoceax.md#L2593"]
relations:
  - { rel: spatial, kind: within, target: "3341" }
  - { rel: spatial, kind: borders, target: "3793", note: "S" }
  - { rel: spatial, kind: borders, target: "3844", note: "SW" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Good Sandreach overview. Correctly identifies two deserts (Mendari/Luquihn), Salt Flats, Forever Beach, Belu Jenari volcano. Lightning Passage section solid. Has TODO political sections."
---
### Geography
