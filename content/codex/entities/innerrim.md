...
sources: ["all_sections_formatted/Rimihuica.md#L3510"]
relations:
  - { rel: spatial, kind: within, target: "2453" }
  - { rel: spatial, kind: borders, target: "3014", note: "east" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Good geographic skeleton with named member states (Qet Yemani, Da Trang, New Chimea, Vystrilik, Eoga). Has 5 TODO placeholders for Political Climate and thematic sections — honest gaps, not inflation. Content is accurate and specific."
---
### Geography
...
- **North**: Bordered by the Middle Sea region and Ofrenia; Swampdeep (a saltwater swamp/bayou) lies to the northeast
- **East**: The Green Mountains, Seawatch Mountains, and Tambrielle Mountains form an east-west barrier separating Innerrim from the Emerald Coast
- **South**: The Cloud Mountains run from southeast to northwest, separating the basin from the Shacklands (particularly Gorath)
- **West**: Transitions into Westrim; the Ishnit Jungles and Thunder Plains mark the western and southwestern edges
