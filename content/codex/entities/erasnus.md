...
name: "Erasnus"
entityType: region
blurb: "A Belenstrope halfling nation in the central Middle Sea region, defined by trade, diplomacy, and a complete inability to fight."
coordinates: [284, 147]
zoomLevel: 3
tags: ["state", "nation"]
...
relations:
  ...
  - { rel: spatial, kind: borders, target: "952", note: "the Hephake mountains" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Halfling trade nation central Middle Sea; bordered by Camaran/Ubrik/Myorna. Coherent."
---
