...
name: "Astrelle"
entityType: region
blurb: "A vassal state of Nektuna, occupying the southern shore of the Tarkhon Passage directly across from the imperial capital."
coordinates: [123, 218]
zoomLevel: 3
tags: ["state", "nation"]
sources: ["all_sections_formatted/Rimihuica.md#L98"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Geography map-confirmed: coastal strip on southern shore of Tarkhon Passage, across from imperial capital Tarkhetan (2574, N across water). Vassal-of-Nektuna/Tarkhon framing consistent. Coherent, specific worldbuilding (Duchess Ysmera, niece Vethira wed to King Selron II). Minor conversational AI padding ('depends on who you ask','Both, probably') could be trimmed but content is sound."
---
