...
name: "Slavos"
entityType: city
blurb: "The capital and largest settlement, built around the primary slave market."
coordinates: [244, 205]
zoomLevel: 5
sources: ["all_sections_formatted/Clueanda.md#L2674"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Geography matches map: capital on largest island's SE harbor ([244,205]), receives raiding/merchant ships. Coherent minotaur slave-market theme consistent with parent 849. Note: prose calls Slavos 'the capital' but entityType is town (two cities Fynol/Pyndar exist); capitalOf authored to Slavos per explicit prose."
---
