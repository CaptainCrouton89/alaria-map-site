...
name: "Gissemari"
entityType: region
blurb: "The artistic heart of the Kingdoms of Fire."
coordinates: [98, 229]
zoomLevel: 3
tags: ["state", "nation"]
sources: ["all_sections_formatted/Rimihuica.md#L485"]
relations:
  - { rel: spatial, kind: borders, target: "2519", note: "N" }
  ...
  - { rel: polity, kind: ruledBy, target: "person-ishari", note: "regency: Prince-Consort Vhelan rules for the child queen" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Trimmed Prince-Consort Vhelan bio, Young Queen Ishari section, detailed artisan guild breakdowns, art market named-character specifics; fixed Yaif direction N→NE in Position and Borders."
---
