...
blurb: "The eastern wall of Moigos, separating the swamplands from Fernius Sound."
coordinates: [38, 339]
zoomLevel: 5
sources: ["all_sections_formatted/Upoceax.md#L531"]
relations:
  - { rel: spatial, kind: within, target: "3405" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Eastern coastal wall of Moigos along Fernius Sound; consistent with [38,339] placement E of capital. On-theme (Kappa mining/caches, Fernius Gap smuggling). Coherent, keep."
---
...
Calentia serves as the gateway to the Urun. Anyone heading into the mountains passes through, and the Kappa-connected merchants there note who goes up and who comes down. Legitimate prospectors are tolerated — they occasionally find something valuable, and their discoveries always seem to benefit the right people. Treasure hunters heading for rumored caches are watched more carefully. Most don't come back.
