...
name: "Flurin"
entityType: region
blurb: "The northernmost of the three Kendrel Kingdoms, occupying a chain of barrier islands and submerged reef-cities along the eastern edge of the Agreben Sea."
coordinates: [117, 290]
zoomLevel: 3
tags: ["region", "kendrel", "greenwater-isles"]
sources: ["all_sections_formatted/Greenwater_Isles.md#L176"]
relations:
  - { rel: spatial, kind: within, target: "4370" }
  - { rel: spatial, kind: borders, target: "4384", note: "south" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme underwater-kingdom prose; geography consistent with map (northern Kendrel sea-region, Glador to south, Atriik across the eastern sea). NOTE: named settlements Azulora(capital), Watalina, Ashenia, Voltunis appear as base-map labels but have NO entity pins — flagged for reconciliation."
---
