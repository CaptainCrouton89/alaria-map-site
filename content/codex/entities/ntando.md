...
name: "Ntando"
entityType: region
blurb: "The forested western interior of Iqes, Ntando is the traditional Qindo heartland — the region where native culture survived most intact after foreign merchants took…"
coordinates: [38, 294]
zoomLevel: 4
sources: ["all_sections_formatted/Upoceax.md#L403"]
relations:
  - { rel: spatial, kind: within, target: "3390" }
  - { rel: spatial, kind: borders, target: "manual-mpii72yw-mnsjt", note: "east" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Corrected: 'forested western interior' changed to 'forested western coast' (pin [38,294] is a western coastal landmass with open ocean to the W); 'highlands along Ntando's western edge' changed to 'eastern edge' (the interior-facing side, not the ocean side). Qindo-heartland prose otherwise coherent."
---
