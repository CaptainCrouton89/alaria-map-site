...
relations:
  - { rel: cosmology, kind: sourceOf, target: "race-human" }
  - { rel: cosmology, kind: sourceOf, target: "race-giant" }
  - { rel: cosmology, kind: sourceOf, target: "race-ulvsjael" }
  - { rel: cosmology, kind: sourceOf, target: "race-sharabha" }
  - { rel: cosmology, kind: sourceOf, target: "race-naga" }
---
Gaea rose alongside the Ezz Rift, born from the flood of psyic energy that transformed Alaria roughly 12 million years ago. She was not made by the titans. She emerged from the material realm itself — the world's own answer to the emotional substrate the Ezz had become. From the first she was strongest here, in the material plane. Not bound to it, since her presence spread across Alaria's full geography, but most fully herself with her hands, figuratively and otherwise, in the ground.
...
<!-- author-notes -->
Eyachria is referenced here but no entity exists yet for it; add a cosmology edge when the Eyachria entity is created.
No race-troll or race-beastmen entity exists in the codex; Gaea's creation of trolls and beastmen is stated in prose only.
Dormancy = Kethic self-expenditure (cosmology-decisions.md §8). Interbreeding rules are also stated in race-elf.md.
