...
name: "Imyena Edhil"
entityType: town
blurb: "The City of the Grieving."
coordinates: [34, 432]
zoomLevel: 5
tags: ["city", "lenora", "exile", "sacred"]
sources: ["all_sections_formatted/Upoceax.md#L1559"]
relations:
  - { rel: spatial, kind: within, target: "3573" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme exile-port concept (City of the Grieving) tightly tied to elven true-name cosmology. Claimed as Lenora member: prose explicitly places it in 'southern Lenora' on the coast, fed by Kilgre Thovrys. Coordinate (34,432) is nearest Amholia Greras CENTROID, but Amholia is an inland forest wilderness; the coastal SW strip is Lenora's. Flagging boundary nuance for reconciliation but content is keep-quality."
---
