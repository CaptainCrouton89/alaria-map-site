...
name: "Krell Lands"
entityType: region
blurb: "A colossal expanse of jungle in southeastern Ve, consumed by the Krell over the past three centuries."
coordinates: [550, 264]
zoomLevel: 3
tags: ["jungle", "region", "ve", "krell"]
sources: ["all_sections_formatted/Ve.md#L1873"]
relations:
  - { rel: spatial, kind: within, target: "1" }
  - { rel: culture, kind: inhabitedBy, target: "race-krell" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Krell Lands comprehensive entry. SE Ve jungle conquered by insectoid Krell over 300 years. Geo consistent with map (SE of Meadow Sound, north of Dygon Beastlands)."
---
