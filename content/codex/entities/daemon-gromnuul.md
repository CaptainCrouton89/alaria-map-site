...
name: "Grømnuul"
entityType: daemon
blurb: "Domains: clan-lineage, ancestor-memory, the long-table fire; current cohort; pan-dwarf ancestor patron of the First Brotherhood."
weight: major
tags: ["daemon"]
aliases: []
sources: []
...
**Worshipped by:** The First Brotherhood; the Drasnian, Uline, Dern, Hestrube, Sennites, Carillon, Gruynmar, and Grendel clans by name, and every clan-hall on Alaria that still keeps a roll of the dead. The Einwissel and the small ghost-clans recite to him even now, from refugee tables that hold only a name or two. (The worships edge is authored downstream on the worshipper, not here.)
