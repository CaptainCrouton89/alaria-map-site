---
id: "event-the-sunless-vigil"
name: "The Sunless Vigil"
entityType: event
blurb: "Five hundred years when the sun's celestial-glass core was corrupted and Koras fought alone to reignite it; the bond between Koras and Bryn deepened after."
tags: ["event", "solar", "cosmology"]
relations: []
review:
  aiWritten: false
  action: keep
...
<!-- author-notes -->
Distinct from the Lost Ages "Dark Night" (shadowrift-caused, ~12,000 BSD, era-lost-ages.md) per the cycle-015 user gate — that one is NOT created as an entity and the string "Dark Night" is deliberately kept out of this file and out of person-bryn's body to avoid the mention-scan auto-linking the two. The Sunless Vigil is solar/Starborn, placed in deep prehistory (post-Bryn-Awakening, during the Sarakiel/Xaphkiel celestial war, well before the Lost Ages). No causation edge to era-lost-ages. Undated on purpose. Cause = a Xaphkiel core-strike (canon: plane-stars-suns-and-moons.md:21, race-fallen-angels-xaphkiel). The seam in the core that "never fully closed" is the live GM hook: if it reopens, another Vigil, and the Dawnless would have reason to help it along. No outgoing edge (relations: []); graph presence comes from person-koras's incoming participatedIn.
