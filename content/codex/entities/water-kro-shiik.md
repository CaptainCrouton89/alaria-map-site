...
name: "Kro Shiik"
entityType: water
blurb: "The central lake of Rakite—a long, shallow body of water fed by the Ver Pes river and drained toward the eastern coast."
coordinates: [55, 400]
zoomLevel: 4
tags: ["lake", "geography", "rakite"]
sources:
  - "atlas_of_alaria/farlands/Kro Shiik.md"
review:
  aiWritten: false
  action: keep
relations:
...
It's a practical place, not a sacred one. The Rakiten value Kro Shiik for what it provides: water, food, and a fixed point in a landscape that otherwise has none.
...
Decisions at the convocation are made by consensus. In practice, this means most decisions aren't made. The tribes are too independent, too suspicious of each other, too committed to their own ways. But the gathering serves other purposes: marriages are arranged, trading conducted, news exchanged, and alliances quietly formed.
...
### The Current Problem
The Roule colonial villages are visible from Kro Shiik on clear days: thin columns of smoke on the eastern horizon, marking where the halflings have burned the grass.

At last year's convocation, the smoke was a constant presence. The tribes debated what to do about it for three days and reached no conclusion. The isolationist faction argued for continued withdrawal. The militant faction argued for war. The largest faction, the one that couldn't agree on anything, argued for more discussion.

This year's convocation is approaching. The smoke will be closer. The debate will be louder. And eventually, someone will have to decide.
