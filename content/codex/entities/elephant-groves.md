---
id: "507"
name: "Elephant Groves"
aliases: ["Elaphant Groves"]
entityType: wilderness
blurb: "The Elephant Groves are the largest forest in the region—a vast, ancient woodland that serves as the birthplace and spiritual homeland of the loxodon race."
coordinates: [247, 248]
zoomLevel: 4
tags: ["forest", "sacred", "region"]
sources: ["all_sections_formatted/Clueanda.md#L747"]
relations:
  - { rel: spatial, kind: within, target: "732" }
---
The Elephant Groves are the largest forest in the region—a vast, ancient woodland that serves as the birthplace and spiritual homeland of the loxodon race. The forest is sacred ground, protected by an ancient elephant spirit that does not welcome uninvited visitors.
...
An ancient elephant spirit protects the Groves. This isn't a metaphor or a legend—the spirit is real, present, and active. It manifests when needed, sometimes as a massive spectral elephant, sometimes as a pressure in the air, sometimes as the forest itself responding to threats.
...
The Elephant Groves border the goblin plains to the north, the Cacklehills to the east, and wilder territories to the south. The forest serves as a stabilizing presence—the spirit's protection prevents the chaos of surrounding regions from spreading, and the Groves themselves are a constant in a landscape defined by conflict.
