...
name: "Dar Qisu"
entityType: city
blurb: "Built around the Great Forge, Dar Qisu is a city of artists, craftsmen, and those who serve them."
coordinates: [102, 231]
zoomLevel: 4
sources: ["all_sections_formatted/Rimihuica.md#L518"]
relations:
  - { rel: spatial, kind: within, target: "2509" }
  - { rel: polity, kind: capitalOf, target: "2509" }
  - { rel: culture, kind: inhabitedBy, target: "race-neferati" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Capital of its kingdom: coherent, on-theme description of the Great Forge city; no geo contradictions with map placement [102,231]. Capital-name correction (cycle-23 #5): invented 'Forgeheart' replaced by true name 'Dar Qisu'; co-located stub 4510 retired; no alias kept per user."
---
