...
blurb: "The Titan Stairs are the western gateway to the Dalizi Highlands, a dramatic stepped formation where the land rises from the lowland Dalizi Confederation toward…"
coordinates: [350, 491]
zoomLevel: 4
sources: ["all_sections_formatted/Aboyinzu.md#L6277"]
relations:
...
The Titan Stairs occupy roughly eighty square miles at the western edge of the Dalizi Highlands, where the Thundering Mountains and Jackal Mountains give way to lower terrain. The formation consists of four distinct plateaus, each roughly 1,000 feet higher than the previous one:

- **First Step** (1,500-2,500 feet): Rolling hills and grassland at the base, still influenced by the Dalizi lowlands
- **Second Step** (2,500-3,500 feet): Drier terrain with scattered forest, accessible from the Chull Lands
- **Third Step** (3,500-4,500 feet): Rocky highlands, sparse vegetation, approaching the Thundering Mountains
- **Fourth Step** (4,500-5,500 feet): Barren plateau merging with the approaches to Fool's Pass

The escarpments between steps range from 500 to 1,000 feet of near-vertical cliff. Ancient paths wind up through gaps and switchbacks, but the climbs are never easy.

#### Origin Theories

The Titan Stairs are geologically unusual. Nothing else in the Dalizi Highlands shows this stepped pattern. Scholars have proposed several explanations:

**Faulting.** The steps represent ancient fault lines where massive blocks of stone shifted upward relative to their neighbors over millennia. This is the most conventional explanation, though it doesn't fully account for the regularity of the formation.

**Erosion.** Differential erosion of layered rock created the terraces, with harder stone forming the plateaus and softer material eroding away to create the escarpments. This theory struggles to explain why the erosion occurred so uniformly.

**Construction.** The stairs were built, shaped by beings with the power to move mountains. Proponents point to the formation's name, arguing that the ancient Dalizi recognized the artificial nature of the terrain. Critics note that no evidence of tool marks or construction techniques has been found.

The Dalizi themselves offer no traditional explanation. The stairs have always been there; the stairs will always be there; the stairs are what they are.
...
#### The Chull Lands Access

The Second and Third Steps connect to the Chull Lands through relatively gentle slopes, making this the easiest access point between the lowlands and the highland interior. Most traffic through the Titan Stairs is heading to or from the Chull Lands, using the stairs to bypass the impassable Toothlar Mountains to the south.
