---
id: "creature-pfustias"
name: "Pfustias"
entityType: creature
blurb: "A swamp dragon of unusual temperament who dwells in the Ogzwad Swamp at the southeastern edge of Phirexes."
tags: ["dragon", "swamp", "emerald coast", "phirexes"]
sources:
  - "bestiary/dragons/Pfustias.md"
review:
  aiWritten: false
  action: keep
---
...
<!-- author-notes -->
The secret Pfustias holds about Phendexelas — the sealed, warded item in her paper-hoard, "the secret the gorgon would kill to protect" — is the full truth of the queen's binding. Full GM detail lives in `person-phendexelas-the-beautiful.md` author-notes; the canonical summary:

- Phendexelas did not find Phirexes alone. The daemon **Olisea** (`daemon-olisea`, current cohort, alive — the Arinsfold daemon of "the shore that becomes home" and the silence that follows the welcome) led the hunted refugee gorgon there offering sanctuary.
- The fog-binding is Olisea's curse, not the queen's own working. Phendexelas is the anchor-knot the curse is tied to — which is why she can fog-bind the Dengar AND why she herself can never leave Phirexes. The jailer is the longest-serving inmate.
- Phendexelas betrayed Olisea: she usurped the worship the curse was built to channel to the daemon, making herself the people's savior-god and starving Olisea of her due (daemon prayer-economy).
- Olisea is still alive and still watching Phirexes, an unpaid creditor waiting to collect.

Pfustias has reconstructed this over fifty years from the written secrets in her hoard. What she intends to do with it stays open, consistent with the existing body. Do NOT edit `daemon-olisea.md` (her public canon is the Arinsfold founding-plague arc; this is a private GM thread requiring no public change there) and do NOT alter Pfustias's dragon-nature, origin, or hoard mechanics — a separate dragon-research thread owns those.
