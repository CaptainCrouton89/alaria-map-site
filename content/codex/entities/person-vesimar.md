...
name: "Vesimar"
entityType: person
blurb: "The Tolarian mage-king who fled Elderran before the Apparatus fired and so escaped the severance. Still alive, still loose, still chasing a purified magic."
aliases: ["Vesimar the Unsevered", "the Unsevered"]
tags: ["villain", "npc"]
relations:
  - { rel: polity, kind: memberOf, target: "faction-tolarian-mage-kings", when: "the final generation", note: "a mage-king who fled before activation and escaped the severance; carries the creed still" }
---
...
What he wants has not changed since the day he left. Vesimar still means to build a magic worked perfectly clean. He treats Elderran not as a refutation of the creed but as a flawed first attempt, a design undone by errors he believes he now understands, and he is looking for the place and the means to try again with the mistakes corrected. This makes him the rarest kind of threat in Old Tolaria's account: not a horror loosed from the ruins but a sane, patient, capable man pursuing the exact ambition that broke the region the first time. He is also the apex example of the region's oldest open wound, that the containment around the dead zone has leaked from the first day. Everything else that escapes Old Tolaria is a beast or a relic or a twisted thing that does not know what it is. Vesimar knows exactly what he is, and he left under his own power before the cordon ever existed to stop him. Where he is now is the question. He does not stay anywhere long, and a man with his patience can afford to be very hard to find.

<!-- author-notes -->
Name Vesimar (epithet "the Unsevered") is LOCKED per Wave 5 brief; flagged provisional (no Tolarian onomastics sheet — matched to the Tolarian register: -mar/-or soft-liquid classical sound). Silas may rename.

He is LOOSE / UNLOCATED by design — no spatial edge, no boundTo. Present location deliberately open (a GM lever / the apex "leak"). Old-tolaria.md (Writer D) names him as the apex escapee; that is the prose two-way for this entity.

Canon leaned on: elderran.md (2881) + magic-time.md — Izzus pockets are "always local and always small," never touch the true clock; his extended life framed as a carried personal time-pocket of stolen Izzus, consistent with that invariant. Brief THE THREE NAMED CHARACTERS (Vesimar fled before/at activation, escaped severance, life extended via carried stolen time, still pursuing purified severed magic, the apex leak). Shared dynasty history consistent with faction + Caedran + Olarane files.

Edges: memberOf → faction-tolarian-mage-kings ONLY (one-direction; reverse computed). No spatial/within, no boundTo (he is unlocated).
