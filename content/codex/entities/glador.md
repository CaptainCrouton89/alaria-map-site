...
name: "Glador"
entityType: region
blurb: "The heart of the Kendrel Kingdoms—oldest, largest, and most stubbornly traditional."
coordinates: [113, 298]
zoomLevel: 3
tags: ["region", "kendrel", "greenwater-isles"]
sources: ["all_sections_formatted/Greenwater_Isles.md#L205"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme underwater-archipelago worldbuilding consistent with the map (ocean tiles between Flurin N and Pelaria S, no land border). Lists settlements (Delphran capital, Aquicada, Telune, Liculvia, Thautias, Caecadis, Neptusia) that have NO map pins — prose-only, does not contradict map. Keep."
---
