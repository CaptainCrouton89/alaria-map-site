...
sources: ["all_sections_formatted/Clueanda.md#L1305"]
relations:
  - { rel: spatial, kind: borders, target: "2817", note: "W" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Region body coherent and strongly map-consistent: W=Silwyn war front, N=Eros, E=coast/Gray Isles, S=Howlwood/Graymist all confirmed by drawn borders. Lengthy 'rules for outsiders' section is padded but on-theme. References capital Theochori + Krania/Balastafika/Malesi (Theochori & Balastafika lack pins)."
---
