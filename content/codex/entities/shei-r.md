...
name: "Sheîr"
entityType: region
blurb: "A sprawling island kingdom on the eastern edge of the Western Isles, where the Shattered Sea meets the Tarkhon coast."
coordinates: [78, 207]
zoomLevel: 3
tags: ["state", "nation"]
sources: ["all_sections_formatted/Western_Isles.md#L1501"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Sheîr is well-developed: Bledreon culture, island tiers (Inner Ring, Drift, Far Reach), Phyndarr Sound trade route, raptor cavalry. 'Eastern edge of Western Isles' matches coords [78,207]."
---
