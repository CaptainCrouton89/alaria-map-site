...
sources: ["all_sections_formatted/Rimihuica.md#L7229"]
relations:
  - { rel: spatial, kind: within, target: "3275" }
  - { rel: spatial, kind: borders, target: "3276", note: "S - Freedom Mountains spine divides the island" }
  - { rel: spatial, kind: borders, target: "3305", note: "SE - Slaver's Coast (southern coast, Gorathi)" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
