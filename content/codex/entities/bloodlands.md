...
blurb: "The scarred buffer zone between Atriik's southern reaches and the Ishnit Jungles, where generations of warfare between the Kor/Sharabha city-states and the Naruaghin tribes have…"
coordinates: [137, 285]
zoomLevel: 4
tags: ["region", "geography"]
sources: ["all_sections_formatted/Rimihuica.md#L1854"]
relations:
...
1. **Dry Season**: Naruaghin war parties move north through the Bloodlands, probing Atriik's defenses. Small raids for slaves, food, and prestige.

2. **Early Rains**: Raiding intensifies as both sides try to secure resources before the rivers flood. Major clashes are more common.

3. **Wet Season**: The Sha Sonisst floods, the jungle paths become impassable, and both sides retreat to defensible positions. Relative peace.

4. **Late Dry**: The cycle begins again.
