...
name: "Camaran"
entityType: region
blurb: "A human republic south of the Kharvorn Mountains, known for its manufacturing economy, anti-magic laws, and rigid bureaucracy."
coordinates: [307, 150]
zoomLevel: 3
tags: ["state", "nation"]
sources: ["all_sections_formatted/Clueanda.md#L541"]
relations:
  - { rel: spatial, kind: borders, target: "864", note: "fortified frontier; Ubrik silvertongue refugees flee into eastern Camaran" }
  ...
  - { rel: economy, kind: tradesWith, target: "652", note: "Camaran precision goods west to Kazül in trade for desert glass" }
  - { rel: polity, kind: ruledBy, target: "person-doravin-selmari", note: "First Consul; rose on the anti-magic statutes after the Camaran Blight" }
  - { rel: history, kind: participatedIn, target: "event-aldriktch-founding" }
  - { rel: history, kind: participatedIn, target: "event-the-camaran-blight" }
...
That suspicion is not old caution. It dates to the Camaran Blight, around 3340 SD, when a Deoric working hired to draw water for the Volari ironworks drew its price instead from the living, and emptied the wards around the foundry in three days. The republic responded by writing the practice of magic out of its law entirely. The statutes make no distinction between the Deoric that spends life and the elemental schools that do not, and in Camaran it is a career-ending act to suggest in public that they ought to. First Consul Doravin Selmari, who as a young magistrate signed the contract that caused the Blight, has built two decades of rule on the ban.
