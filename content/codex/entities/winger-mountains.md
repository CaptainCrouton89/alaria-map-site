---
id: "376"
name: "Winger Mountains"
entityType: wilderness
blurb: "A smaller range in the central-southern Krell Lands, the Winger Mountains are less densely populated by the insects than their northern counterpart."
coordinates: [549, 274]
zoomLevel: 3
tags: ["mountains", "geography", "ve", "krell"]
sources: ["all_sections_formatted/Ve.md#L3308"]
relations:
  - { rel: spatial, kind: within, target: "211" }
---
...
1. **Getting there** — The approach passes through active Krell territory
2. **The terrain** — The Wingers themselves are difficult to navigate
3. **The unknowns** — Whatever keeps the Krell out may not be friendly to humans either
4. **Getting back** — The return journey is just as dangerous
