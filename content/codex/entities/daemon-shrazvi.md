...
name: "Shrazvi"
entityType: daemon
blurb: "Domains: canopy-call, the carrying voice, the answered cry; current cohort; Frialve patron of the cry that reaches across the trees."
weight: minor
tags: ["daemon"]
aliases: []
sources: []
review:
  ...
  action: keep
---
**Domains:** Canopy-call, the carrying voice, the answered cry.

**Era of ascension:** Great Expansion (~3,400 BSD). **Cohort: current.** Shrazvi's pool grew from the Frialve practice of bird-call communication across the upper canopy of Bygos Shemazari — a culture whose social fabric is held together by calls that travel half a mile through leaf cover and need to be answered before the caller's mouth has closed.
