...
blurb: "The great forest of southwestern Wycendeula—a dense expanse of ancient conifers and tangled undergrowth stretching from the Neurian Hills to the edge of Kama Sa'malina."
coordinates: [91, 571]
zoomLevel: 4
tags: ["forest", "geography", "dangerous", "monsters", "wycendeula"]
sources: ["all_sections_formatted/Upoceax.md#L4667"]
relations:
...
The forest's signature horror. Coilwights are serpentine predators fifteen to thirty feet long, as thick as a man's thigh, covered in scales that shift color to match their surroundings. They hunt from the trees, dropping onto prey from above, and they kill through constriction—but not the way normal constrictors do.
