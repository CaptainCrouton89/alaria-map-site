...
name: "Shredwreck"
entityType: ruins
blurb: "The scattered remains of the Golden Sovereignty, a treasure galleon that went down in the waters near the Golem's Teeth three generations ago."
coordinates: [56, 293]
zoomLevel: 5
tags: ["shipwreck", "poi", "salvage"]
sources: ["all_sections_formatted/Upoceax.md#L839"]
relations:
  - { rel: spatial, kind: within, target: "3399" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Shredwreck (Golden Sovereignty wreck) near the Teeth; coherent, on-theme, map-consistent."
---
