...
name: "Starfish Isles"
entityType: region
blurb: "A sprawling archipelago of low-lying islands, sandbars, and reef systems stretching north of Enavadi into open water."
coordinates: [60, 262]
zoomLevel: 4
tags: ["island", "geography", "fishing"]
sources: ["all_sections_formatted/Upoceax.md#L897"]
relations:
  - { rel: spatial, kind: within, target: "3342" }
  - { rel: spatial, kind: borders, target: "3354", note: "southwest" }
  - { rel: spatial, kind: borders, target: "4242", note: "north" }
  - { rel: spatial, kind: borders, target: "3357", note: "south" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Map-verified; body geography fully correct, no changes. Confirmed: Mueras [86,253] is E of isles [60,262] (body says east, correct); Walker Depths between isles and Mueras coast 'to the east' matches map; Labyrinth Sound [72,263] is due E dist 12 (body says east, correct); Enavadi [59,274] is S, isles 'stretch north of Enavadi' correct; open water lies WEST per map (teal open ocean left of isles). Border edges 3354 Floss Is SW, 3357 Enavadi S consistent. Prior inversion fix held."
---
