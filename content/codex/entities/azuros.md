...
name: "Azuros"
entityType: region
blurb: "Azuros clings to the highest peaks of northern Erpeus, a collection of stone villages surrounding the ancient Shogi Monastery."
coordinates: [238, 181]
zoomLevel: 4
tags: ["state", "nation"]
sources: ["all_sections_formatted/Clueanda.md#L353"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme wind-monk theocracy. Map-confirmed: northern peaks of Erpeus island. Some AI flourish ('absence of relations') but vivid and consistent. Keep."
---
...
Reaching Azuros requires climbing through Lier's Murder Hills and then ascending paths that would challenge mountain goats. Most people never try. Those who do arrive in a place that feels untouched by time—the same stone buildings, the same rituals, the same silence that has defined the monastery for centuries.
...
The Shogi Monastery has developed air magic techniques found nowhere else on Alaria. Students begin by learning to feel the wind—not just as weather but as a presence, a partner, eventually an extension of themselves.
...
- **Flight**: True flight, not just gliding or jumping—sustained movement through the air
...
Azuros doesn't have relations with the world—it has an absence of them. The monastery trades nothing, fights no one, and participates in no politics. Lier's merchants have tried repeatedly to establish commerce; they always fail. The gnomes of Mkinti don't bother trying.
