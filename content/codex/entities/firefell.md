...
name: "Firefell"
entityType: ruins
blurb: "The shattered remains of an ancient Neferati colony in the Ember Isles—a city that tried to harness volcanic power and paid the price."
coordinates: [33, 228]
zoomLevel: 4
tags: ["poi", "ruins"]
sources: ["all_sections_formatted/Western_Isles.md#L549"]
relations:
  - { rel: spatial, kind: within, target: "4210" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Firefell is detailed and internally consistent with Ember Isles entity. Three-zone ruin breakdown (Upper, Rim, Sunken City) works well. Kingdoms of Fire connection adds political stakes. Ember Lord rumor is good hook."
---
