...
name: "Thespia"
entityType: region
blurb: "A human agricultural kingdom in chaos."
coordinates: [201, 158]
zoomLevel: 3
tags: ["state", "nation"]
sources: ["all_sections_formatted/Clueanda.md#L2510"]
relations:
  - { rel: spatial, kind: borders, target: "692", note: "NW" }
  - { rel: spatial, kind: borders, target: "768", note: "E" }
  - { rel: spatial, kind: borders, target: "801", note: "N" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent on-theme nation body. Geography matches map: Morgnor's Cradle NW, Stipen E, Ta Minn N, Glorin S. Settlement subheads (W/N/E/S) align with pin clusters. Keep; note Telford/Embrulton/Dadleigh/Syozlus/Wediton lack pins."
---
