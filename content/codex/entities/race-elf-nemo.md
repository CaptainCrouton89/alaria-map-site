...
entityType: race
entityCategory: race
blurb: "Ghostly descendants of Caerene who sought immortality through forest-oneness; eternally trapped as cold, bitter spirits in the Eros forests."
aliases: ["Lost Ones"]
tags: ["playable"]
relations:
  - { rel: culture, kind: subraceOf, target: "race-elf" }
  - { rel: culture, kind: worships, target: "daemon-vaerivra", note: "ghost-share; Caerene patron prayed to as spirits" }
sources:
  - "races/Elf.md"
review:
  aiWritten: false
