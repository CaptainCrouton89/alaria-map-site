...
name: "Lier"
entityType: region
blurb: "Lier occupies the central portion of Erpeus Island, sandwiched between the gnomish mountains of Mkinti to the south and the monastic peaks of Azuros to…"
coordinates: [237, 188]
zoomLevel: 4
tags: ["state", "nation"]
aliases: ["Lier - Erpeus Island", "Erpeus Island"]
sources: ["all_sections_formatted/Clueanda.md#L1655"]
relations:
  - { rel: spatial, kind: within, target: "540" }
  - { rel: spatial, kind: borders, target: "670", note: "NE" }
  - { rel: spatial, kind: borders, target: "681", note: "SW" }
  - { rel: spatial, kind: borders, target: "449", note: "N" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Well-written region body; geography (Mkinti to S/SW, Azuros to N, Murder Hills NE) matches map adjacency. Minor: 'Gam' nested oddly under Devil's Crest heading and has no pin (possible missing entity)."
---
