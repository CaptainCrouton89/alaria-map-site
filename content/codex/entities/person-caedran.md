...
name: "Caedran"
entityType: person
blurb: "The last Tolarian mage-king and chief architect of the Apparatus of Severance, frozen conscious at its heart living the disaster he caused."
tags: ["villain", "npc"]
relations:
  - { rel: polity, kind: memberOf, target: "faction-tolarian-mage-kings", when: "the final generation", note: "the last mage-king; chief architect of the finished Apparatus and the one who threw the switch" }
  - { rel: possession, kind: boundTo, target: "artifact-apparatus-of-severance", note: "frozen at the Apparatus's heart, its unwilling operator" }
---
...
<!-- author-notes -->
Name Caedran is LOCKED per Wave 5 brief; flagged provisional (no Tolarian onomastics sheet — matched to the Tolarian register: Tolaria/Elderran/Velorax, soft liquids + classical -ran ending). Silas may rename.

Canon leaned on: elderran.md (2881) — Apparatus four goals, partial-success-worse-than-failure, central-spire dilation where "decades pass in seconds," "mage-kings may still be alive, frozen in the instant of their greatest triumph and their worst failure"; magic-time.md — Izzus dilation is local only. Parallels Velorax (also frozen conscious above the spire) deliberately per brief. Apparatus mechanics deferred to artifact-apparatus-of-severance.md and elderran.md (not restated). Shared dynasty history kept consistent with faction + Olarane + Vesimar files (Caedran threw the switch; Olarane warned; Vesimar fled).

Edges: memberOf → faction-tolarian-mage-kings; boundTo → artifact-apparatus-of-severance. Both one-direction (reverse computed). The Apparatus file does NOT author the reverse (Writer A instructed not to).
