...
name: "Bluesong Bay"
entityType: water
blurb: "Bluesong Bay is a large inlet on the western coast of Central Aboyinzu, notable primarily for who doesn't use it."
coordinates: [245, 506]
zoomLevel: 3
tags: ["bay", "geography", "coastal"]
sources: ["all_sections_formatted/Aboyinzu.md#L973"]
relations:
...
The bay extends roughly 80 miles inland from the Untouched Sea, with a width of 40-50 miles at its mouth narrowing to about 20 miles at its deepest point. The waters are calm compared to the open sea, protected by the Sokorgül peninsula to the north.

**Coastline Features:**
- **Northern Shore**: Where Sokorgül forest meets the water. Dense woodland comes nearly to the waterline. No settlements.
- **Eastern Shore**: Scrubland and grassland of Tythikerys. The Royko River empties here, creating a marshy delta.
- **Southern Shore**: The Mumbling Forest dominates this stretch, its trees growing to the water's edge.
- **A small island**: Sits in the northern portion of the bay, unnamed and uninhabited.
...
Bluesong Bay should be one of the most valuable maritime assets in southwestern Aboyinzu. It offers:
- Protected anchorage from open-sea storms
...
Every generation, some Kadrokan leader proposes seizing a foothold on the bay. Every generation, the plan fails. The problems are straightforward:
...
The bay remains tantalizing and unreachable, a constant reminder of what the Tytheri blockade costs Kadroka.
...
- Lights beneath the water at night, particularly near the Mumbling Forest shore
- The unnamed island occasionally appearing to have structures on it that aren't there when approached

Whether these are real phenomena, tricks of the "singing" water, or sailor's tales is unclear. Few ships enter the bay, and fewer still linger.
