---
id: "region-sun-forsaken-north"
name: "Sun-Forsaken North"
entityType: region
blurb: "The permanently frozen far north, beyond any prayer-coalition's reach, where ruined sunlit-era cities stand beneath glaciers and relict wildlife outlived the warmth that bred them."
...
The ruins themselves attract a particular kind of desperate interest. The records inside describe the prayer-coalitions that held Bryn overhead, the rituals, the organizational structures. Some have been partially translated. They suggest the warmth-windows were longer and more controlled than historians assumed—not accidents of coalition strength but deliberate, sustained efforts by groups that understood precisely what they were doing. What ended them, and whether it was voluntary, remains unclear.

<!-- author-notes -->
No coordinates assigned — this is a conceptual/world-spanning region representing the entire permanently-cold far north, not a specific mapped area. No within edge added: no single existing entity serves as a sensible geographic parent for a world-spanning polar concept. Clueanda (id: 388) covers the frozen northwestern crown and could nominally overlap, but the sun-forsaken north extends beyond any one continent.

Sun elves and the Vykus may have a role in the sun-ward history of this region; that thread is explicitly open — do not specify.
