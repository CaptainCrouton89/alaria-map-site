...
name: "Regina"
entityType: city
blurb: "The capital of Ethadia sprawls across the southern shore of Strymün's main harbor—a natural bay so perfect for shipping that the city's founding was essentially…"
coordinates: [201, 377]
zoomLevel: 4
sources: ["all_sections_formatted/Rimihuica.md#L7123"]
relations:
  - { rel: polity, kind: capitalOf, target: "3317" }
  - { rel: spatial, kind: within, target: "3314" }
  - { rel: culture, kind: inhabitedBy, target: race-human }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Capital of Ethadia on Strymun's southern main harbor; matches map coord [201,377] (red star). Coherent, on-theme maritime-aristocracy writeup. capitalOf 3317 edge intact; placed within 3314."
---
