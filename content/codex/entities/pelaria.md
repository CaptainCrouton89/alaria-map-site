...
name: "Pelaria"
entityType: region
blurb: "The volcanic kingdom."
coordinates: [108, 304]
zoomLevel: 3
tags: ["region", "kendrel", "greenwater-isles"]
sources: ["all_sections_formatted/Greenwater_Isles.md#L599"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme volcanic-kingdom worldbuilding. Placement (southern eastern Agreben Sea) matches map: Pelaria label sits in open water S of the Kendrel Kingdoms cluster. Settlements (Saphinia capital, Brilina, Osirey, Purine, Levirus, Naurey, Coralona) are map text labels with NO pins. Body links to 'Pelaria (State)' doc that does not exist as a separate entity — broken ref for reconciliation."
---
