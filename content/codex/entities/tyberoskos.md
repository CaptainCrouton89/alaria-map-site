...
blurb: "South of the Pearly Mountains, where the land descends toward the coast, Tyberoskos spreads across rolling hills of limestone and clay."
coordinates: [73, 366]
zoomLevel: 4
sources: ["all_sections_formatted/Greenwater_Isles.md#L1075"]
relations:
  - { rel: spatial, kind: within, target: "4446" }
  - { rel: culture, kind: inhabitedBy, target: "race-gnome-qipi" }
---
...
When Nyxara goes dark, the weretigers lose themselves. The transformation is involuntary and total—not just physical but mental. They become apex predators driven by instinct, hunting anything that moves with terrible efficiency. Even their own families are not safe; weretiger camps scatter before the new moon, individuals isolating themselves to minimize the carnage.
