---
id: "2798"
name: "North Naruaghin Tribes"
entityType: region
blurb: "The North Naruaghin occupy the jungle territories surrounding Ekomorn, the great rift that plunges to the center of the material plane."
coordinates: [136, 296]
zoomLevel: 4
tags: ["state", "nation"]
sources: ["all_sections_formatted/Rimihuica.md#L3022"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme tribal-confederation lore (ancestor-worship, Ekomorn rift vigils, dragon Pythalomos, bone temples). Geography map-consistent: jungle around Ekomorn rift (2713, E) in the Ishnit Jungles; isolationist northern sibling of East (2662) tribes. Notable locations (Keth-Voram, Watcher's Spine, Ekomorn's Edge) are prose-only flavor with no map pins. NOTE: pin shares identical coords [136,296] with 2662 East Naruaghin — coord collision needs reconciliation (one pin misplaced)."
---
