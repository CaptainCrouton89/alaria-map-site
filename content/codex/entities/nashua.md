...
name: "Nashua"
entityType: region
blurb: "Two hundred miles of toxic marshland, tangled jungle, and patient death."
coordinates: [313, 307]
zoomLevel: 3
tags: ["region", "marshland", "lizardfolk"]
sources: ["all_sections_formatted/Rimihuica.md#L4001"]
relations:
  ...
  - { rel: culture, kind: inhabitedBy, target: "race-lizardfolk-ixvasyla" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Trimmed: removed 7 invented river towns (Hyobinii, Sipokno, Dolno Jelovce, Nikolici, Poyux, Kisava, Lukshax); replaced with summary of 3 confirmed pins (Tirexonos, Vosx, Svintiste); fixed Sviniste→Svintiste spelling; moved Sylthik Dolno Jelovce reference to Vosx"
---
...
1. **The Toxic Marshes**: Central and western Nashua, the heartland—flooded lowlands, mangrove forests, and the ancestral territory of the Ix'Vasyla
2. **The River Corridor**: Eastern Nashua, where the Jiji River and its tributaries support the major settlements
3. **The Southern Scrublands**: Drier, sparser terrain toward the coast—the most vulnerable to Gorathi incursion
