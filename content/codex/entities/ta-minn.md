...
zoomLevel: 2
tags: ["state", "nation"]
sources: ["all_sections_formatted/Clueanda.md#L2430"]
relations:
  - { rel: spatial, kind: borders, target: "591", note: "E" }
  ...
  - { rel: history, kind: participatedIn, target: "event-ta-minn-expansion" }
  - { rel: polity, kind: atWarWith, target: "426", note: "contested Kanüli Daha Plains" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Oznak horse theocracy on western Middle Sea steppes; coord matches."
---
