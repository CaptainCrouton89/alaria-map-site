...
name: "Uhionai"
entityType: region
blurb: "The far northwestern orc state, occupying the ancient Ryunimir Forest."
coordinates: [128, 132]
zoomLevel: 3
tags: ["state", "nation", "orc"]
sources: ["all_sections_formatted/Clueanda.md#L5168"]
relations:
  - { rel: spatial, kind: within, target: "981" }
  - { rel: spatial, kind: borders, target: "1035", note: "east" }
  - { rel: spatial, kind: borders, target: "1150", note: "southeast" }
  - { rel: culture, kind: inhabitedBy, target: "race-orc-uihonaii" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Uhionai: far-NW orc state in Ryunimir Forest. Matches map [128,132] near Ryunimir [131,134]. Interior for own worker."
---
