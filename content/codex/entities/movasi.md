...
name: "Movasi"
entityType: region
blurb: "A large island in the southeastern Greenwater Isles, Movasi is covered almost entirely by the Dream Jungle—a bioluminescent forest where the boundary between waking perception…"
coordinates: [137, 355]
zoomLevel: 3
tags: ["island", "state", "nation", "geography", "pilgrimage", "psychedelic"]
sources: ["all_sections_formatted/Greenwater_Isles.md#L287"]
relations:
  - { rel: spatial, kind: within, target: "4363" }
  - { rel: culture, kind: inhabitedBy, target: "race-dwarf-velwey" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Rich lore on Movasi/Dream Jungle/Velwey dwarves. Specific place names (Telugai Bay, Holik, Pool of Names). Gulf of Norag and Sea of Spiders as surrounding waters matches map orientation. Distinct and inventive premise."
---
