...
name: "Adi Assabehta"
entityType: city
blurb: "The capital city, built into and around the larger of the two Iri peaks."
coordinates: [285, 174]
zoomLevel: 4
sources: ["all_sections_formatted/Clueanda.md#L665"]
relations:
  - { rel: spatial, kind: within, target: "494" }
  - { rel: polity, kind: capitalOf, target: "494" }
  - { rel: culture, kind: inhabitedBy, target: "race-gnome-echi" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Adi Assabehta = Echea's capital, vertical city in the larger Iri peak; Zylogmus flipside-binding secret is strong specific canon. capitalOf+within authored."
---
