...
name: "Shinori Island"
entityType: region
blurb: "The largest island in the northern Pesalolo archipelago, and the lair of Agtakkeri the Flayed Banner."
coordinates: [181, 339]
zoomLevel: 4
tags: ["island", "geography", "shacklands", "dragon"]
sources: ["all_sections_formatted/Rimihuica.md#L6806"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Detailed, internally consistent, on-theme dragon-lair lore (Agtakkeri/Skinning Grounds). Geography matches map: largest island W of marker, Pukot N, Liki S. No map contradiction."
---
...
The irony is not lost on anyone. Agtakkeri has saved more escaped slaves than any underground railroad—not because it cares about them, but because killing Gorathi is more important.
...
**Liki Forest island** lies to the south, named for the dense woodland covering its entire surface. The island is uninhabited and largely unexplored. Fishermen avoid it—not because of the dragon, but because the currents around Liki are unpredictable, and the forest has a reputation. What that reputation involves, the fishermen don't specify. They just don't go there.

#### Hooks

- **The Survivor's Tale**: A Drasnian dwarf survived weeks on Shinori before escaping to Pukot. They know the island's layout, Agtakkeri's patterns, and the location of something they saw in the jungle—something that predates the dragon. They want help retrieving it.

- **Into the Lair**: Someone needs something from Agtakkeri's trophy collection—a ship's log, a specific banner, evidence of what happened to a particular vessel. Getting in and out without disturbing the dragon will require perfect timing and significant luck.

- **Liki Forest**: The fishermen's warnings about Liki are vague but consistent. Something lives in that forest. With Agtakkeri's territory so close, investigating seems suicidal—which is exactly why no one has done it.

- **The Pukot Question**: The fishing community has survived near Agtakkeri for generations. How? The dragon ignores them, but why? Some suspect an old arrangement. Others think the community has been compromised. The truth might be simpler—or much more complicated.
