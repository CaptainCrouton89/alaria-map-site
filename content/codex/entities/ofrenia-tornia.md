...
name: "Tornia"
entityType: region
blurb: "Tornia is the northernmost state within Ofrenia, one of the three kingdoms controlled by feuding siblings on the strategically vital island at the heart of…"
coordinates: [267, 185]
zoomLevel: 3
sources: ["all_sections_formatted/Clueanda.md#L84"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Stubbed: expanded from single-sentence restatement to 3-paragraph entry covering Alisandra's rule, 8 member settlements, contested Joswik border, Sylke western border, and political positioning."
---
