...
sources: ["all_sections_formatted/Aboyinzu.md#L6617"]
relations:
  - { rel: spatial, kind: within, target: "1388" }
  - { rel: culture, kind: inhabitedBy, target: "creature-kanzekill" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Trimmed from 28.5k: kept Geography overview, Political summary (Kanzekill/Nydor/surface kingdoms), Azanfrain and Tidewatcher's Perch as key hooks; cut What Makes It Interesting, What Will Go Wrong, full Azanfrain sub-sections, Lakes/Rivers detailed sections, Hurly Hills and Windred Bluffs TODO stubs"
---
### Geography
