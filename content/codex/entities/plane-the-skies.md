...
<!-- author-notes -->
The killing-moon mystery has a concrete answer, withheld from the player-facing body: the Syngers' immortality and thin-air tolerance do not protect them from the raw planar bleed of the destabilization periods (Ethereal/Nethereal energy mixing, per plane-stars-suns-and-moons). When the high skies fill with that light, the Syngers descend below the bleed-line and ride out the period in the lower atmosphere, or seal themselves inside their vessels. They are not killed; they retreat. They simply do not explain themselves to anyone below.

The composition and propulsion of Synger Vessels is left unexplained on purpose — race-syngers.md establishes the craft as inexplicable to mortal science; do not resolve it here.

Skystone is treated as the same high-floating, super-dense rock noted in plane-stars-suns-and-moons ("super-high density sky-stones, which float incredibly high up"). Skystone trade routes are the niche specialty of the scholar Tybalexyn (person-tybalexyn) if a future entry wants attribution — not used here, since attribution is approval-gated.

Possible reciprocal note for race-syngers.md (FLAGGED for orchestrator, not edited here): a livesIn/originatedIn edge from race-syngers → plane-the-skies would close the loop, but per task instructions only the inhabitedBy edge on this entity was authored.
