...
name: "Kazül"
entityType: region
blurb: "A desert kingdom on the southern Middle Sea coast, ruled by King Salomor and his legendary summoning ring."
coordinates: [205, 178]
zoomLevel: 3
tags: ["state", "nation"]
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Geography matches map: south of Glorin, SW of Zintacas (652 at 205,178; Zintacas NE). Coastal desert kingdom on Middle Sea. Subhead leads (Dygalva, Buffalo Islands, Porizzon) all map-confirmed. Coherent, specific, on-theme. Note: 'Seneka' subhead name has no matching pin (Yalami at 206,174 is the likely intended northern river settlement)."
---
