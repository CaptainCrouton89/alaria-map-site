...
blurb: "Tythikerys is a vast stretch of arid scrubland in southwestern Central Aboyinzu, homeland of the Tytheri blood orcs."
coordinates: [260, 512]
zoomLevel: 3
tags: ["plains", "region", "orc territory"]
...
- **Bluesong Bay**: Western coastline, controlled by the Tytheri but barely used
- **Mumbling Forest**: Southwestern coastal forest, avoided by most orcs
- **Bloodswamp**: Northern border region where multiple rivers converge before entering Tytheri territory
- **Fury Hills**: Southeastern hills bordering Kadroka
- **Redreed Lake**: Terminal lake in the south, fed by the Dutunimako River
...
**Thralls**: Captured slaves from Kadroka and elsewhere. Thrall life is brutal and short. Many are worked to death; some are consumed in Ichor rituals; a few are traded to other peoples for goods the Tytheri cannot make themselves.

#### Raiding Patterns

Tytheri raids follow seasonal patterns:
...
Outsiders sometimes wonder why the Tytheri control such vast territory when they barely use it. The answer is simple: denial.

As long as the Tytheri hold the coastal approaches and the land around the Agony Stones, Kadroka cannot access the sea and cannot threaten the Ichor supply. The empty scrubland is a buffer zone, a killing ground for any Kadrokan force that tries to push through.

The orcs don't need to build cities. They just need to make sure no one else does either.
...
The southwestern coast of Tythikerys is dominated by the Mumbling Forest, a dense woodland that most Tytheri avoid. The forest gets its name from the constant low sound that pervades it—not quite voices, not quite wind, but something in between.

Whatever lives in the Mumbling Forest, it does not bother the orcs and the orcs do not bother it. A tacit understanding exists: the forest is not Tytheri territory, regardless of what maps might suggest.
...
Outsiders who enter Tytheri territory face three threats:

1. **The Orcs**: Obviously. Small parties will be hunted. Larger parties will be watched and harassed until they leave or die.
