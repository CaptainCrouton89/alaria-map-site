...
name: "Earth"
entityType: magic
blurb: "The Kethic element of stone and soil, channeled through the Golus leyline. Not a gift of Gaea, and split between shapers and diviners."
tags: ["magic", "elemental"]
sources:
  - "magic_and_knowledge/elemental_magic/Earth.md"
review:
  aiWritten: false
  action: keep
---
...
The element keeps two traditions that barely speak to each other. Earthshapers move the world, and the dwarven holds raise the art to a standard no chisel touches, cutting ore-rich rock clean and closing a gallery on command. The other tradition does not shift a single stone. Geomancers listen to it, channeling Golus to feel the strain in a cut face, the creep of water through deep rock, the slow grind of a fault far below. A geomancer who warns a hold that its ceiling will come down by winter is not prophesying. She felt the rock already failing. The old reputation for foretelling is a misreading of a real and much narrower gift.
