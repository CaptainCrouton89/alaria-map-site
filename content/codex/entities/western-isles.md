...
sources: ["all_sections_formatted/Western_Isles.md#L1"]
relations:
  - { rel: spatial, kind: borders, target: "4324", note: "western boundary, Stratlan Sea" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Trimmed 20k-char body: removed embedded Foggy Isles and Tollgate full articles (reduced to summary sentences), removed TODO sections (Political Climate, What Makes It Interesting, What Will Go Wrong), removed Stratlan Sea/Lonely Island/Ognarad sub-article, removed Siren Islands raw authoring notes, trimmed all per-member paragraphs to 1-2 sentences. Result is overview + surrounding waters + brief member survey."
---
## Geography
...
- **Stratlan Sea**: The deep, empty ocean to the far west—the true edge of the known world
- **Iron Sea**: Northern waters, between the islands and Clueanda
- **Sea of Merchants**: Eastern waters separating the islands from the Tarkhon Empire
- **Sea of Sharks**: Southern waters below the central archipelago
