...
name: "Qintas"
entityType: region
blurb: "A coastal state in Central Aboyinzu, home to a significant Amverela high elf population and famous across Alaria for Sondoros wine."
coordinates: [300, 412]
zoomLevel: 3
tags: ["state", "nation"]
sources: ["all_sections_formatted/Aboyinzu.md#L2372"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Qintas coastal elven wine-state premise is coherent. Capital Constancias identified. Light leyline integration consistent with Grustos lore."
---
...
The most famous forest in Qintas—possibly in all of Central Aboyinzu—renowned for the strange grape-like fruit that grows on vines climbing its trees. The wine produced from this fruit is legendary, said to be fit for gods, and is sought after by connoisseurs across Alaria.
