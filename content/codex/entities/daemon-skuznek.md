...
name: "Skuznek"
entityType: daemon
blurb: "Domains: scorpion cult, venom-as-virtue, the sting that proves the warrior; current cohort; Husakas patron of the initiation that does not heal cleanly."
weight: minor
tags: ["daemon"]
aliases: []
sources: []
...
<!-- author-notes -->
Deliberate deviation: the slot recipe encourages a glottal apostrophe in Husakas-register names (Qord'ik-style, sheet-attested). I omitted the apostrophe deliberately. Husakas doctrine treats the patron's name spoken with a glottal pause as an invitation to the sting outside the rite; the written form follows the spoken form, and Husakas warriors do not write the daemon's name with the pause that asks. The apostrophe is suppressed throughout the corpus on Husakas-internal usage.
