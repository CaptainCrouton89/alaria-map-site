...
coordinates: [360, 523]
zoomLevel: 3
sources: ["all_sections_formatted/Aboyinzu.md#L4711"]
relations:
  - { rel: spatial, kind: within, target: "1864" }
  - { rel: spatial, kind: borders, target: "1979", note: "N" }
  - { rel: spatial, kind: borders, target: "1977", note: "NW" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Rewrote from one-liner stub. Grounded on capital Sarmamyo, 5 towns, lake-south geography, and border neighbors Mpaso (N) and Samani (NW)."
---
