---
id: "artifact-apparatus-of-severance"
name: "Apparatus of Severance"
entityType: artifact
blurb: "The crystalline engine at Elderran's heart that tore the Izzus seam to seize time itself. It cannot be shut off, and it still runs."
weight: legendary
tags: ["artifact", "cosmology"]
relations:
  - { rel: spatial, kind: within, target: "2881" }
  - { rel: cosmology, kind: attunedTo, target: "magic-time" }
  - { rel: origin, kind: createdBy, target: "faction-tolarian-mage-kings" }
review:
  aiWritten: false
  action: keep
---
...
> I gave the word. I have been taking it back ever since, and the word has not yet finished leaving my mouth.
> — Caedran, last of the Tolarian mage-kings, heard in the minds of those who reach the heart
...
The Apparatus cannot safely be shut off. The mage-kings designed it to sustain itself through the long work of severance, and the partial, broken version of that work is exactly what it continues to perform. Century by century it completes the separation it was built for, a fraction at a time, and the magical instability bleeding outward across Alaria can be traced in part to its endless operation. The reckoning held by those who study it is grim and specific: within roughly another century the engine finishes, and a finished severance is worse for the world than the unfinished one has ever been. Stopping it means reaching a nexus no one has reached and living. Until someone does, the engine keeps its own slow time, and the men who built it keep failing to turn it off.

<!-- author-notes -->
Provisional names (no Tolarian onomastics sheet exists; matched to the Tolarian register — Tolaria, Elderran, Velorax — soft liquids, classical, -ran/-or endings; Silas may rename):
- Caedran (`person-caedran`) — referenced in prose + the closing voice inset. His file (Writer B) authors the `boundTo` edge into this artifact; I author no edge to him.

Two-way / partition notes:
- Prose backlinks named here for entities other writers own: Elderran (2881, Writer C hub), Velorax (creature-velorax-the-unfinished, Writer C), the Tolarian mage-kings (faction-tolarian-mage-kings, Writer B), Caedran (Writer B). Their reciprocal prose/edges are handled on their side per the brief. I did NOT edit any of those files.
- Edges authored FROM this file only: within→2881, attunedTo→magic-time, createdBy→faction-tolarian-mage-kings. No imprisons/boundTo authored here (those come from persons/Velorax).

Canon notes:
- attunedTo→magic-time is intentional (the Apparatus IS the seam-tear mechanism); not a duplicate-conflict per the brief.
- This is the SECOND recorded Izzus tear (after the Torn Hour / Plains of Oblivion); the seam bends only the local rate, never true history / the Great Cycle (magic-time.md, world-systems-invariants.md). Prose kept consistent with that.
- NOT wired to and NOT conflated with `event-the-severance` (the unrelated Tarkhon dynastic break). The Apparatus's seam-tear has no event entity (decision D1).
- Deliberately did not restate Elderran's four-severance breakdown or its staged-approach list; deferred to elderran.md and referenced it.
