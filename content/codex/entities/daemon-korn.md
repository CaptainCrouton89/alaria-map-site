...
name: "Korn"
entityType: daemon
blurb: "Domains: caste-order, labor as prayer, the work that holds the world up; current cohort; pan-koren patron of the load borne."
weight: minor
tags: ["daemon"]
aliases: []
sources: []
...
<!-- author-notes -->
Naming provisional: koren sheet sparse (Kor / Korel only). Monosyllabic, single short -o, hard close honored per recipe. Refine when sheet pool grows.
<!-- /author-notes -->
