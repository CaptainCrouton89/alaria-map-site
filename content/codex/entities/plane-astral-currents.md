...
sources:
  - "cosmology_and_religion/alarian_planar_stack/Astral_Currents.md"
review:
  aiWritten: false
  action: keep
...
The currents extend downward into the transitional zone where the Astral Sea meets the Material Plane's atmosphere. Ships cannot reach the true Astral Sea—that would require ascending thousands of miles into increasingly dense astral solution—but they can ride these currents where they dip closest to the ground: a few thousand feet above the surface.
...
Astral stones that reach the surface are incredibly valuable. Some lodge in the ground upon impact; others drift through the skies until netted. Either way, extracting and securing one represents a massive capital investment—the foundation of the entire sky trade.
...
Aether engines provide this propulsion. Aether—a meta-fluid energy that arrived in Alaria from the planar stack Lanthornia—exists invisibly throughout the atmosphere. Certain creatures can sense and extract it; the most commercially important are the **aether weaver goblins**, who harvest raw aether and process it with water into usable fuel.

The engine mechanism involves lanthornium—an uncommon gray-blue stone that requires expensive purification. When purified lanthornium vibrates at a specific frequency and contacts processed aether, the aether rapidly expands, driving pistons or turning propellers. Well-designed engines use self-striking mechanisms: the initial strike causes vibrations that trigger subsequent strikes, creating a sustained power cycle similar to a steam engine.
