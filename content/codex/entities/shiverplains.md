...
name: "Shiverplains"
entityType: region
blurb: "The Shiverplains stretch across the central interior, a vast grassland that gets its name from the way the wind makes the tall grass ripple in…"
coordinates: [246, 238]
zoomLevel: 4
tags: ["plains", "region"]
sources: ["all_sections_formatted/Clueanda.md#L2212"]
relations:
  - { rel: spatial, kind: borders, target: "567", note: "north" }
  - { rel: spatial, kind: borders, target: "470", note: "northeast" }
  - { rel: spatial, kind: borders, target: "752", note: "east (Azawahasi frontier)" }
  - { rel: spatial, kind: borders, target: "624", note: "southeast" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent on-theme Scalawag-goblin grassland lore. Geography matches map: Bygone Hills NE (470), Jinxz Plains S/SE (624), Azawahasi/Plains of Eregnar E (752), Eloweir NW (no entity pin). Sachi Plains = northern section (Sarih Plains 755 pin). No member settlement pins (semi-permanent camps, none placed)."
---
