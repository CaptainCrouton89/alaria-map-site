...
name: "Aglip Scha"
entityType: ruins
blurb: "A village abandoned during a plague called the Weeping Rot, now a pilgrimage site for death-cultists, plague-doctors, and those who seek to understand mortality."
coordinates: [213, 261]
zoomLevel: 5
tags: ["ruins", "plague", "pilgrimage", "religion"]
sources: ["all_sections_formatted/Rimihuica.md#L3553"]
relations:
  - { rel: spatial, kind: within, target: "2803" }
---
...
The Weeping Rot is not gone. It is dormant.
...
The contamination's exact location remains unknown. Finding it would mean ending the danger forever—but also potentially releasing it.
...
- **Deliberate Release**: A faction within the pilgrim community has decided that the Weeping Rot is sacred—not just the village, but the plague itself. They intend to release it deliberately, as a "gift" to the world. They must be stopped, but violence within sight of the village is considered ultimate desecration.
