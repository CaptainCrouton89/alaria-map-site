...
name: "Olisea"
entityType: daemon
blurb: "Domains: green-water shore, new-land arrival, the shore that becomes home; current cohort; Arinsfold patron of the welcome and the silence that follows it."
weight: standard
tags: ["daemon"]
aliases: []
sources: []
...
<!-- author-notes -->
The founding-plague is canonical (per `race-halfling-arinsfold.md` line 14): a plague that swept the native Roulean human population to ninety-percent lethality within two generations of Arinsfold arrival. Canon names no cause; the silence is doctrinal. Olisea's worship treats the silence as load-bearing. The patron knows what the worshippers refuse to say aloud: the plague was a knowing biological consequence of Arinsfold settlement — not deliberate weaponization, but allowed to run through the native population without aid, intervention, or quarantine, because the shore was wanted and the inhabitants were in the way. The cult is what the silence costs. Prose hints at the resolution without naming it explicitly; the founders' grandchildren acclaimed Olisea as the daemon of the shore that becomes home, which is the same as acclaiming her as the daemon of the silence that makes it home. Per the planner's no-lazy-mysteries directive and the founding-plague resolution embedded in the sub-plan.
