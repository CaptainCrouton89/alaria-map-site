---
id: "faction-tolarian-mage-kings"
name: "Tolarian Mage-Kings"
entityType: faction
blurb: "The seven-generation dynasty that ruled Old Tolaria and built the Apparatus of Severance to purify magic by tearing its tangled traditions apart."
tags: ["dynasty", "old-tolaria", "villain"]
review:
  aiWritten: false
  action: keep
---
...
> Mixed magic is a lie told quickly enough that no one catches it. We are not building a weapon. We are building the truth a sentence at a time, and the truth does not care how long it takes.
> — attributed to Aurelan, founder of the line
...
<!-- author-notes -->
Provisional coined names (no Tolarian onomastics sheet exists; matched to the established Tolarian register — Tolaria, Elderran, Velorax: soft liquids, classical, -ran/-or/-ane endings): Caedran, Vesimar, Olarane (all LOCKED per Wave 5 brief), plus Aurelan (founder, prose-only, no entity) coined here. Silas may rename. Grep-clean at authoring (Aurelan, and the three locked names).

Canon leaned on: elderran.md (2881) — four severance goals, partial-success-worse-than-failure, still-running machine, "mage-kings may still be alive, frozen"; mount-tolaria.md (2911) — summit observatory/citadel, glassified ruins; magic-time.md — Izzus seam bends only local rate, never true history; brief THE THREE NAMED CHARACTERS + LOCKED CANON. Olarane authored as frozen at Elderran (boundTo edge lives in her file). Vesimar's extended life framed as a carried local time-pocket of stolen Izzus, consistent with magic-time's "always local, always small."

Edges: NONE authored from this file (faction is navigable via inbound computed edges — 3× memberOf from the persons + createdBy from the Apparatus). No within edge by design.
