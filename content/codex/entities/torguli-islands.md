---
id: "3460"
name: "Torguli Islands"
entityType: region
blurb: "A long, curving chain of islands stretching southwest from the main Tyvern archipelago into open water."
coordinates: [23, 331]
zoomLevel: 4
tags: ["island", "geography"]
sources: ["all_sections_formatted/Upoceax.md#L937"]
relations:
  - { rel: spatial, kind: within, target: "3342" }
  - { rel: spatial, kind: borders, target: "3412", note: "NE — chain trails SW from the Tyvern archipelago / Isle of the Night cluster" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme navigational lore for an uninhabited island arc. Geography matches map: chain trails SW into open water from the Tyvern archipelago (NE), as drawn. No member pins; no inflation. Keep."
---
