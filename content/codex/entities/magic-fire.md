...
name: "Fire"
entityType: magic
blurb: "The Kethic element of flame and heat, channeled through the Yolus leyline, whose surfacing beneath Tarkhetan feeds the Evertorch and the Firemage Corps."
tags: ["magic", "elemental"]
sources:
  - "magic_and_knowledge/elemental_magic/Fire.md"
review:
  aiWritten: false
  action: keep
relations:
  - { rel: cosmology, kind: sourceOf, target: "manual-mpha3di4-etrb5", note: "Fire leyline (Yolus) is the material source of the Evertorch flame" }
  - { rel: cosmology, kind: sourceOf, target: "era-world-fire", note: "The Yolus seam is the elemental source of the World Fire's catastrophic rupture" }
  - { rel: cosmology, kind: channels, target: "2574", note: "Fire leyline beneath the Old City powers the Firemage Corps" }
  - { rel: cosmology, kind: channels, target: "3824", note: "The Yolus leyline runs close under the surface at Firefrost Hills" }
---
