---
id: "3436"
name: "The Scattered Islands"
entityType: region
blurb: "Dozens of islands dot the sound, ranging from bare rocks that barely break the surface to forested islets large enough to camp on."
coordinates: [35, 321]
zoomLevel: 5
sources: ["all_sections_formatted/Upoceax.md#L751"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme archipelago vignette (fishing camps, smuggler caches, neutral meeting points, Kappa influence). Geography consistent with map: islands in Scatter Sound; 'Tuktuk villages' = Tyvern Isles people, 'Eskiloko settlements' = adjacent E coast. No permanent settlements, so no member pins exist. Mild three-bucket bolded structure typical of AI but specific enough to keep."
---
