...
name: "Hedroscobb"
entityType: region
blurb: "The largest orc state in the Wildwood, controlling the southern forest from Vogenfeld's mountain passes to the Yugurbas Dyos marshes."
coordinates: [126, 170]
zoomLevel: 3
tags: ["state", "nation", "orc"]
sources: ["all_sections_formatted/Clueanda.md#L3901"]
relations:
  - { rel: spatial, kind: within, target: "981" }
  - { rel: spatial, kind: borders, target: "1022", note: "N" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Hedroscobb: largest orc state, southern Wildwood (Vogenfeld passes to Yugurbas). Matches map [126,170]. Interior for own worker."
---
