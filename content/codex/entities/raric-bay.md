...
name: "Raric Bay"
entityType: water
blurb: "A large crescent bay along the southern Innerrim coast where the fish are already dead when you catch them."
coordinates: [227, 299]
zoomLevel: 3
...
Whether the castle is meant to contain the Unfallen or awaken it is a matter of interpretation. The Nashua scholars believe it's a lock—that the Unfallen itself, in some pre-conscious way, recognized the danger it posed and guided Tugon to build a barrier. The more pessimistic view is that the castle is a beacon, a focusing lens, a way for the Unfallen to concentrate its influence until it can finally complete the death it started before death existed.

The final line of the specifications—"When it wakes, this will not be enough. Build more."—suggests that whoever or whatever wrote them expected the Unfallen to eventually overcome a single castle. No one has built more. No one knows where they would build them, or what shape they would take.
