...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Continental overview of Aboyinzu, accurate geographic description with 7 sub-regions correctly identified. Featured Regions section aligns with actual entity graph. No filler; serves well as top-level entry."
---
...
The Crimson Coast is the continent's isolated southwest, cut off behind the Dragon's Spine and bounded to the south by the ocean its people call the Void. It earns its name. Three states hold the coast: Klevnaf and Istora, the two halves of a Winter Elf kingdom that broke apart in a succession war, and the human kingdom of Tangiern, which pays tribute to neither claimant and keeps its head down. The rivers here are not safe. The River of Wights, Murder Creek, the Pools of Tragedy, all of them carry the residue of old killing, and Murder Creek's stain is still spreading.
...
> You'll see the lights some nights, way down, green and moving. Throw a line, drop a lamp, shout yourself hoarse. Nothing comes up. Forty years I've fished the Riptear and not once has one of them broke the surface. They watch the boats. I'd stake my hull on it.
> — a Riptear fisher, harbor at Aal Salma
...
> She flies the south ridge every third day, regular as a tide. The second day's the safe one. Anybody tells you different is selling you a guide you don't need.
> — saying among the Dhabisa highland drovers
...
<!-- author-notes -->
Crimson Coast haunting — canonical cause (withheld from public prose): the haunting is the
accumulated shadow-residue (shadow → Malstaris strand, per three-strand death) of the violently
dead from centuries of Istori civil war. The root event is the regicide of King Istor XXVI and the
succession war between his daughter Lamenrae and his uncle Taoinor, the conflict that split the
kingdom into Klevnaf and Istora along Murder Creek. The killer's identity is left open in public
prose per the mysteries rule (each faction blames the other); the GM-knowable fact is that the cause
is human-scale and traceable, not a primordial curse, and Murder Creek's active spread is fresh
shadow-leakage, not a static old haunting.

Cendoriln (Riptear Sea / off Terrenia) — canonical motive (withheld from public prose): they are not
motiveless. Per race-kendor-cendoriln.md (id race-kendor-cendoriln), the Cendoriln are master
secret-keepers and blackmailers who "trade in information that could topple kingdoms"; their aspects
are "Secrets are currency" and "I thrive where others fear to swim." They worship the daemon Velaendor
(daemon-velaendor). The Riptear diaspora is the most isolationist branch: it maintains NO contact with
surface nations and often refuses even the Kendrel Kingdoms, "considering themselves purer
practitioners of Kendor tradition, uncorrupted by surface influence," and is known to the surface
"only through rare Pelaendor encounters." So the silence toward the surface is a purity doctrine, not
an absence of motive. GM-knowable lever: what they want is secrets/leverage, and a secret valuable
enough is the one thing that could draw them up or open negotiation. Velaendor is deliberately NOT
named in the public prose to keep them enigmatic.

Kanzekill is a Force dragon (per the Dragon's Spine Coast member, id 2201). The sacred-three Dragon
lineage (Nagatayora → Naga, per world-systems-invariants.md) is NOT asserted of her here because no
source ties her to that lineage; she is kept as a Force dragon and the Dark Elf Dragon Purge terrain
is the threaded connection instead. If a future canon decision links Kanzekill to the Naga lineage,
this passage can be tightened to say so.

Rokunuri: no onomastics sheet exists (docs/worldbuilding/onomastics/ has no onomastics-rokunuri.md),
so no Rokunuri proper names are used — descriptive reference only.

Anchor Trees — what they are "waiting for" is an unresolved canon thread (the dossier frames it as an
open hook, not a settled answer). Per the open-thread / mysteries rules I did NOT invent a hard
cosmological resolution, since that risks colliding with locked titan/Celestia canon in
world-systems-invariants.md. Public prose is framed so the waiting reads as a known disposition plus
an actionable lever (the druids beginning to "remember on the trees' behalf"), not a hollow
"nobody knows." Knowable facts asserted: distributed consciousness; titan corpses bound by druids;
Faesong + Deoric binding; pre-emotion memory. If/when canon decides the trees' purpose, tighten here.

Naming flags carried from the dossier: race-elf and race-rokunuri files spell the continent
"Aboyuinzu" (typo); correct spelling "Aboyinzu" used throughout. "the Void" is used only as the
Crimson Coast's local name for the southern ocean; the overview uses "South Sea." "Slumbering Abyss"
(Elder Wilds member) deliberately NOT elevated to a cross-continent sea name.
