---
id: "3859"
name: "Malo Kon Greikh"
entityType: region
blurb: "The dominant giant nation in the southern Giant Lands, comprising a loose confederation of city-states along the Xcraya River Valley and surrounding highlands."
coordinates: [95, 460]
zoomLevel: 3
tags: ["state", "nation", "giants"]
sources: ["all_sections_formatted/Upoceax.md#L4053"]
relations:
  - { rel: spatial, kind: within, target: "3844" }
  - { rel: culture, kind: inhabitedBy, target: "race-giant-greikh" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Good detail on giant confederation structure, 12 city-states named with distinct identities. Xcraya River Valley geography is coherent. Prisoner Hills and Xcraya Pallir features add depth."
---
