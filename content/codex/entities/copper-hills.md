...
blurb: "Low, scrubby hills in western Kerwin, rich with copper ore."
coordinates: [177, 175]
zoomLevel: 4
...
relations:
  ...
  - { rel: culture, kind: inhabitedBy, target: "creature-desert-mammoth" }
  - { rel: culture, kind: inhabitedBy, target: "race-goblin-rudding" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Copper Hills within Kerwin; rich body, hosts Chykum mining town. Minor: body says 'western Kerwin' but coords [177,175] place it N of center—still inside. Keep."
---
