...
name: "Xi Chin"
entityType: city
blurb: "A marble city grown into the wreck of a fallen Mira orb-ship, high in the Tethryns, whose aura traps anyone who stays past a few days."
coordinates: [78, 349]
zoomLevel: 4
sources: ["all_sections_formatted/Greenwater_Isles.md#L949"]
relations:
...
> "You are met at the gate by a child who asks the day of your arrival, and met again each morning by that same child, who tells you how many you have left. On the fourth morning she does not smile. Cross her on the fifth and she has already stopped counting you among the living."
> — from a Harborflame envoy's notes on the embassy to Xi Chin

<!-- author-notes -->
Deep origin of the orb-ships and what the Mira are is deliberately left open in-body, consistent with race-mira.md; do not resolve it here. The aura's cause, knowable to the GM: the sphere emits a preservation field that kept its Mira passengers whole across whatever long passage first brought them. The field binds any body that lingers in it, retuning the body's regulation to depend on the field's presence. The Mira are native to it and feel only longing and listlessness when away; non-Mira physiology adapts within four or five days and can no longer re-regulate once severed past that point, which is what kills departing visitors. This is why Mira travel freely between spheres and others cannot. The "fell from the sky" framing is literal and ancient; no claim is made about other worlds, and nothing here should be read as contradicting the canonical planar stack.
