...
name: "Aneryxika"
entityType: daemon
blurb: "Domains: island navigation, the archipelago as a single known thing, the channels between islands; current cohort; Ansari patron of the between-water the open-sea gods do not know."
weight: minor
tags: ["daemon"]
aliases: []
sources: []
...
<!-- author-notes -->
Deliberate deviation: the slot recipe specifies the gnome short-exotic register (Ansari's own register: openers An-/Ne-/Yi-, terminals -ari/-iri/-eri). Aneryxika is in the gnome high-syllable register instead (Tyberoskos / Nykotheryx Amberylika family — Aner- opener, -yx- interior, -ika terminal). The doctrinal reason: Ansari channel-knowledge is itself older than the short-exotic personal-name fashion the enclaves now use day-to-day, and the patron's name was already in the high-syllable register when Ansari was a younger people. The name is preserved unchanged because the Ansari treat the daemon's name as part of the channel-knowledge — to modernize the name is to alter the chain through which the worship has been carried, and Ansari pilots refuse the alteration on doctrinal grounds.
