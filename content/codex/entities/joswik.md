...
name: "Joswik"
entityType: region
blurb: "Joswik occupies southern Ofrenia, a land of mountains, fertile valleys, and windswept plateau."
coordinates: [259, 207]
zoomLevel: 3
tags: ["state", "nation"]
sources: ["all_sections_formatted/Clueanda.md#L1495"]
relations:
  - { rel: spatial, kind: within, target: "720" }
  - { rel: spatial, kind: borders, target: "398", note: "north" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Trimmed: removed invented settlements (Valeria, Trenton/Greymill, Sculpton, Shardak, Canfaldo, Dagmanton, Welldale) and corrected spellings to pinned forms (Bankstad, Oysterton, Elissmar, Pastureton). Replaced with compact correct-spellings paragraph. Kept intro paragraphs and Gulf of Joswik; removed Valeria reference from Gulf section."
---
...
Prince Edric governs from Padena, watching his sister Alisandra's armies occupy the north and waiting for the inevitable. The landscape that makes Joswik hard to govern also makes it hard to conquer—but everyone knows Alisandra will try eventually.
