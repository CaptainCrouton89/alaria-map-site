...
sources:
  - "all_sections_formatted/Ve.md#L1987"
review:
  aiWritten: false
  action: keep
---
...
> The river never asks the sea for directions. You are upstream of your own question, and it is already wet. Wait. It will reach you, or it will not.
> — Thornlace, one of the Five Who Speak
...
<!-- author-notes -->
Truth-lines GM grounding: the perception is real, not delusion. The lines are an aspect of Ezz the Iliko sense natively — the thought/intention face (Psywinds) running as visible currents of meaning. Kept experiential and unnamed in the body to preserve the deliberate prophets-or-lunatics ambiguity established in the Locquine city entry (id 224); the body asserts the perception is genuine without pinning it to a named force in player view.

"Ascension" (referenced in the Locquine entry, where a member of the Five Who Speak "ascends" and is replaced): an Iliko whose truth-line sight grows total stops perceiving the material world as separate from the lines. They cease acting as an individual and effectively dissolve into the pattern the others read. The body is left behind or simply not found. The pixies celebrate it as completion, not death. Withheld from player-facing text by design; this is the GM-side answer.
