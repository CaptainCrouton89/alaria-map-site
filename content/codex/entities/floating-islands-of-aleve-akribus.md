---
id: "3368"
name: "Floating Islands of Aleve Akribus"
entityType: wilderness
blurb: "A cluster of islands that hang suspended in the air above the sea, southwest of the Torguli Islands chain."
coordinates: [7, 333]
zoomLevel: 4
tags: ["island", "geography", "magical"]
sources: ["all_sections_formatted/Upoceax.md#L217"]
relations:
...
No one knows why they float. The islands have hung in the air for as long as anyone remembers, and theories about their origin range from ancient magic to leyline anomalies to something buried in the islands' cores that defies natural law. Whatever the cause, the effect is undeniable: these islands do not touch the water.
...
The islands drift. Not quickly — their movement is measured in feet per day rather than miles — but continuously. The cluster's general position remains consistent (southwest of the Torguli chain), but individual islands shift relative to each other. Gaps that existed yesterday may be closed today; islands that were neighbors may have drifted apart.
...
**Prison**: The islands were raised to isolate something dangerous. What lives there isn't a population — it's a captive, or captives, kept away from the world for reasons that remain valid.
