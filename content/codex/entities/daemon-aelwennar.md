...
name: "Aelwennar"
entityType: daemon
blurb: "Domains: language, inherited memory, song-as-archive; current cohort; Druidic Long-Song daemon whose name refuses to be broken into two."
weight: major
tags: ["daemon"]
aliases: []
sources: []
...
<!-- author-notes -->
DEVIATION from the slot's onomastic recipe: E-2's recipe specifies a formal two-word compound (matching E-1 Eluvarin Aelweir). This entry uses a single fused word — Aelwennar — instead. Justification: the Long-Song daemon's identity is "the song that cannot be broken into pieces," so a two-word name would contradict the patron's defining attribute. The deviation is the load-bearing theological fact of the slot. (Wave 2 deliberate-deviation count: 2 of 3.)
