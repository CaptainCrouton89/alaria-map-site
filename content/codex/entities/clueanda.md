...
relations:
  - { rel: spatial, kind: borders, target: "2455", note: "south" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
...
> Two great whites sleep up there, and they have agreed not to wake each other. Pray you are not the thing that wakes them.
> — a Wydling elder
...
> They have raised the strait toll three times since my father sailed it and lowered it not once. You do not argue with Tarkhon. You raise your own prices and pass the cost to the next fool down the line.
> — a Kazul shipping factor
...
<!-- author-notes -->
Sun-frozen ruin: placed under the Nysanna glaciers, building on the canonical "glaciers occasionally release ancient things frozen within them" hook in the Nysanna Range member body (id 1328) and the locked atlas text in overview-geography.md ("cities that stood under open sun in older eras... froze where they stood, grain still sealed in their jars"). Kept deliberately un-named and un-mapped so no member file has to track a metropolis. The KNOWABLE answer (per the mysteries rule) is stated in-text: the city froze because the Bryn-trail window that warmed this latitude closed and the warmth never returned. The identity of the builder-coalition is left open ON PURPOSE — the atlas itself calls it a "forgotten coalition," so the openness is canon, not a withheld secret. A GM may name it freely; nothing downstream depends on it.

Data flags carried from research-clueanda.md (not authored into the public body):
- Did NOT reference the Seyiki / Piktiniti / Postronamas / Jüt / Enimogos content found in the Westwilds member body (id 981). It reads as misplaced Rimihuica desert content (sand desert, pillar-ruins, saltwater lakes) that contradicts Westwilds' arid-scrub geography. Flagged for the data team.
- Did NOT repeat the unverified sea name "North Sea" from the Northlands body (id 1311); it is not in the canonical sea list. Nysanna calving and Celedrim's northern boundary are described against the Ocean of Azeros / unnamed polar waters instead.
- Dreamplains (Celedrim, Celestia-thinness + impact craters) kept explicitly distinct from the sun-frozen ruin — different mechanism, stated as such in-text.

Tarkhon Strait consistency (must match rimihuica.md / Tarkhon Empire id 2455): strait is the ONLY western sea route into the Middle Sea; Tarkhon holds and taxes it solely; it is the Middle Sea's WESTERN exit past Kazul; Clueanda's Westwilds faces the northern approach; Clueanda borders Tarkhon to its south. No Clueanda faction is claimed to control or contest the strait, and no alternative route is named or implied. Vogenfeld/Hedroscobb lever is framed as a threat TO the strait's northern flank, not as Clueandan control of it.
-->
