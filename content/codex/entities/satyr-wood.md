...
blurb: "Three hundred miles of dense woodland stretching from Falsehaven Bay to the Fyrsan Al Troikas mountains, and roughly seventy-five miles deep."
coordinates: [246, 461]
zoomLevel: 4
tags: ["forest", "geography", "satyr lands"]
sources: ["all_sections_formatted/Aboyinzu.md#L2660"]
relations:
  - { rel: spatial, kind: within, target: "1706" }
  - { rel: culture, kind: inhabitedBy, target: "race-satyr-greater-satyr" }
  - { rel: culture, kind: inhabitedBy, target: "race-satyr-lesser-satyr" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Coherent Greater Satyr worldbuilding. Geography matches map: Fyrsan Al Troikas mountains to the E (1574 confirmed NE), Falsehaven Bay to W, Pythol Lake/River to SW/S — all consistent with pin coords. Lakes Noso/Pirison are unpinned lore-only sites (no map pins; report as missing). Keep."
---
Three hundred miles of dense woodland stretching from Falsehaven Bay to the Fyrsan Al Troikas mountains, and roughly seventy-five miles deep. This is Greater Satyr territory—not merely inhabited by them, but shaped by them over centuries of bloody ritual, caste warfare, and the strange music that echoes through every valley.
