...
name: "Nektuna"
entityType: region
blurb: "The imperial heartland of the Tarkhon Empire, controlling both shores of the Needle—the strait's narrowest point and the key to everything."
coordinates: [126, 197]
zoomLevel: 3
tags: ["state", "nation"]
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Corrected: Position/Borders North changed from 'Enymu' to 'Vogenfeld' (2582); East changed from 'Tarkhon Passage' to 'Enymu and Stone Forest' (Enymu is E dist ~30 from Nektuna). Relationships section 'to the north' changed to 'to the east'. Content otherwise sound; Tarkhetan capital, Evertorch, Needle all confirmed."
---
