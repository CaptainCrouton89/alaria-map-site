...
relations:
  - { rel: cosmology, kind: attunedTo, target: "magic-water", note: "Pelus/cold-Kethic fused into and displaced part of the strand-set" }
review:
  aiWritten: false
  action: keep
---
