---
id: "3833"
name: "Kilbyurn Mountains"
entityType: wilderness
blurb: ""
coordinates: [114, 493]
zoomLevel: 3
tags: ["mountains", "geography"]
sources: ["all_sections_formatted/Upoceax.md#L3866"]
relations:
  - { rel: spatial, kind: within, target: "3902", note: "Western border range of Wycendeula" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Expanded from TODO; extracted prose from parent 3902 body (which was simultaneously trimmed), dropped invented monster catalog (Granite Wyrms, Cloudwalkers, Thornback Swarms); kept: Empty Mountains framing, river headwaters, three named passes, Giant Question."
---
