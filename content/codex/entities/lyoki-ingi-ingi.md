---
id: "3260"
name: "Lyoki Ingi Ingi"
entityType: region
blurb: "A dense rainforest peninsula stretching south from the Shacklands interior, where the Mudzwiti goblins have built a civilization around death, dinosaurs, and the slow accumulation…"
coordinates: [336, 384]
zoomLevel: 3
tags: ["jungle", "geography", "mudzwiti", "shacklands"]
sources: ["all_sections_formatted/Rimihuica.md#L6525"]
relations:
  - { rel: spatial, kind: borders, target: "3300", note: "west" }
  - { rel: spatial, kind: within, target: "3151" }
  - { rel: culture, kind: inhabitedBy, target: "race-goblin-mudzwiti" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme worldbuilding (Mudzwiti goblins, utahraptor symbiosis, tomb-legacy culture). Geography matches map: isolated jungle peninsula in the South Sea, Shykasas archipelago to the west. The 8 named villages (Chikowe, Gondowe, Chriunda, Mpakati, Kadivivire, Nanda, Baswi, Matsikiti) have map text labels but no entity pins — flagged for reconciliation."
---
