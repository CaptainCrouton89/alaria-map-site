...
name: "Zintacas"
entityType: region
blurb: "A tribal Gozi (Goshwen) nation in the canyon country south of Stipen."
coordinates: [216, 171]
zoomLevel: 3
tags: ["state", "nation"]
sources: ["all_sections_formatted/Clueanda.md#L2908"]
relations:
  - { rel: spatial, kind: borders, target: "768", note: "N" }
  - { rel: spatial, kind: borders, target: "652", note: "SW" }
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent, on-theme canyon-nation writeup; geography (canyon country S of Stipen, coastal E edge) matches map. Casual author voice ('Utah/Arizona vibes'). Subheads (Sighing Canyons=765, Lizard's Back=774, villages, raptors) are real leads. Keep."
---
