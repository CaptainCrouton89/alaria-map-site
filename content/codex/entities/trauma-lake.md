...
name: "Trauma Lake"
entityType: water
blurb: "A large lake on the eastern edge of Eberri Ygonzi, where the forest gives way to the approaches of Kama Sa'malina."
coordinates: [108, 576]
zoomLevel: 5
tags: ["lake", "geography", "dangerous", "wycendeula"]
sources: ["all_sections_formatted/Upoceax.md#L5719"]
relations:
  - { rel: spatial, kind: within, target: "3946" }
---
...
Some survivors report seeing something in the lake. Not clearly—Trauma Lake's darkness obscures details—but shapes moving in the depths. Large shapes. Slow-moving. Watching.
