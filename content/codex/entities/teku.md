...
name: "Teku"
entityType: city
blurb: "A city-state on Survivor's Island, in the heart of the Sea of Sharks."
coordinates: [62, 240]
zoomLevel: 4
tags: ["city", "state", "nation"]
sources: ["all_sections_formatted/Western_Isles.md#L1711"]
relations:
  - { rel: spatial, kind: within, target: "4305" }
  - { rel: polity, kind: capitalOf, target: "4305" }
review:
  aiWritten: true
  archetype: ai-ok
  action: keep
  notes: "Teku is an excellent city-state entry. Survival premise well-executed: Barrier Harbor, shark hunters, crossing trade. Admiral Kess Ironhull is a strong NPC. Good connection to Islands of Gold."
---
