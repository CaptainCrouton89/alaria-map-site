...
name: "Vaeloten"
entityType: daemon
blurb: "Domains: silence, the seen gesture, the sight-bond; current cohort; Rakiten patron whose true name is a sign, not a sound."
weight: standard
tags: ["daemon"]
aliases: []
sources: []
...
**Worshipped by:** The Rakiten, in sight-bond communities where shared sightline is the precondition of worship. Any sign-language tradition descended from Rakiten contact — there are a handful, mostly trade-pidgins in coastal cities — preserves a residual reverence even when the practitioners no longer know what they are honoring. (The worships edge is authored downstream on the worshipper, not here.)
