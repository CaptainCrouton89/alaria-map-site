...
name: "Enymu"
entityType: region
blurb: "The breadbasket of Tarkhon—a farming state that feeds the empire but sees little of the wealth."
coordinates: [157, 192]
zoomLevel: 3
tags: ["state", "nation"]
sources: ["all_sections_formatted/Rimihuica.md#L274"]
relations:
...
review:
  ...
  archetype: ai-ok
  action: keep
  notes: "Coherent on-theme farming-state lore; geography matches map (W Nektuna, N Wurn Mtns, E frontier->Kerwin, S Tarkhon Passage). Named NPCs (Aldric IV, Beren, Kira Stoneheart) and prose-only towns (Stoneheart Vale, Borderwatch) have no pins but are narrative flavor, not geo errors."
---
...
- **West**: Nektuna (and the Stone Forest on the border)
- **North**: The Wurn Mountains (home to the Stone Men)
- **East**: Frontier territories, eventually leading to Kerwin
- **South**: The Tarkhon Passage (Midton Island and Ekfusy fortress lie offshore)
